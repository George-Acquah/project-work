...
const SlotImagesScreen = () => {
  ...
  const uploadSlotImages = async () => {
    ...
    if (imagesToUpload.length > 0) {
      ...
      dispatch(
        showErrorModal({
          message: "No file Selecetd",
          description: "Select an image or capture one",
...
export default SlotImagesScreen;
